    ...
    <body>
        ...
        <?php
            ...
            if (isset($_GET['action'])) {
                $deleted = $conection->exec('DELETE c, a, g FROM grupos g LEFT JOIN albumes a ON g.codigo = a.grupo LEFT JOIN canciones c ON a.codigo = c.album WHERE g.codigo =' . $_GET['action']);
            }
            ...
            foreach ($result->fetchAll() as $names) {
                ...
                echo ' <a href="/index/delete/' . $names['codigo'] . '">🗑️</a>';
                echo '<br>';
            }
